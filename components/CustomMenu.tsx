...
const CustomMenu = ({ title, state, filters, setState }: Props) => (
    <div className="flexStart flex-col w-full gap-7 relative">
        ...
        <Menu as="div" className="self-start relative">
            ...
            >
                <Menu.Items className="flexStart flex-col absolute left-0 mt-2 sm:min-w-[300px] w-fit max-h-64 origin-top-right rounded-xl  border border-purple-500 shadow-menu overflow-y-auto">
                    {filters.map((tag) => (
                        <Menu.Item key={tag}>
                            <button
                                type="button"
